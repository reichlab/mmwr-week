...
exports.MMWRWeeksInYear = exports.DateToMMWRWeek = exports.MMWRWeekWithDelta = exports.MMWRWeekToDate = undefined;
 ...
 */
var MMWRWeekWithDelta = exports.MMWRWeekWithDelta = function MMWRWeekWithDelta(year, week, delta) {
  year.should.be.a('number');
  week.should.be.a('number');
  ...
  if (delta > 0) {
    var maxWeek = MMWRWeeksInYear(year);
    return {
      year: out > maxWeek ? year + 1 : year,
      week: out > maxWeek ? out - maxWeek : out
    };
  } else {
    var _maxWeek = MMWRWeeksInYear(year - 1);
    return {
      year: out < 1 ? year - 1 : year,
      week: out < 1 ? _maxWeek + out : out
    };
  }
};
